...
class MediaAssetControllerTest {
    ...
    @MockitoBean
    private com.dasigconnect.backend.service.MediaRightsService mediaRightsService;
    ...
    void list_authenticated_returnsPagedAssets() throws Exception {
        ...
        MediaAssetListResponseDto response = new MediaAssetListResponseDto(
                ...
                1,
                25);
        when(mediaAssetService.list(any(), any(), any(), any(), any(), any(), any(Integer.class), any(Integer.class), any(), any(), any()))
                .thenReturn(response);
