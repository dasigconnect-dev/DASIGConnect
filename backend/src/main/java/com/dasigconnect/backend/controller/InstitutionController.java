 ...
 *
 * All endpoints are restricted to SUPER_ADMINISTRATOR role via @PreAuthorize. The JWT
 ...
 * @PreAuthorize("hasRole('SUPER_ADMINISTRATOR')") works correctly with M1's enum.
 *
