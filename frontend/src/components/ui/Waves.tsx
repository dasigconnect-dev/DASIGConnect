...
const Waves: React.FC<WavesProps> = ({
  lineColor = 'rgba(24, 119, 242, 0.15)',
    ...
    function movePoints(time: number) {
      ...
      lines.forEach((pts) => {
        pts.forEach((p) => {
          ...
          if (dist < l) {
            const s = 1 - dist / l;
            const fVal = Math.cos(dist * 0.001) * s;
            p.cursor.vx += Math.cos(mouse.a) * fVal * l * mouse.vs * 0.00065;
            p.cursor.vy += Math.sin(mouse.a) * fVal * l * mouse.vs * 0.00065;
          }
