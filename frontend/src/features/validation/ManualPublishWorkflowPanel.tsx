            ...
            <>
              ...
              <section style={{ padding: "18px 24px", borderBottom: "1px solid var(--val-border, #e2e8f0)", display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", fontWeight: 700, color: "var(--val-text)" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "22px", height: "22px", borderRadius: "50%", background: "var(--val-blue, #1877f2)", color: "white", fontSize: "12px", fontWeight: 800 }}>1</span>
                  Copy Content
                </div>
              ...
              <section style={{ padding: "18px 24px", borderBottom: "1px solid var(--val-border, #e2e8f0)", display: "flex", flexDirection: "column", gap: "12px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", fontWeight: 700, color: "var(--val-text)" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "22px", height: "22px", borderRadius: "50%", background: "var(--val-blue, #1877f2)", color: "white", fontSize: "12px", fontWeight: 800 }}>2</span>
                  Post to Facebook
                </div>
                <a
              ...
              <section style={{ padding: "18px 24px", display: "flex", flexDirection: "column", gap: "14px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "14px", fontWeight: 700, color: "var(--val-text)" }}>
                  <span style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: "22px", height: "22px", borderRadius: "50%", background: "var(--val-blue, #1877f2)", color: "white", fontSize: "12px", fontWeight: 800 }}>3</span>
                  Record Details
                </div>
